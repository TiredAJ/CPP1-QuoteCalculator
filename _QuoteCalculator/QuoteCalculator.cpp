...
const int SC_Option = 1;	//for ScreenCleanerTM
...
{//to handle the customer's address
	...
	void DisplayAddress()
	{
		string FormatLine;
		Graphics(1);
		cout << "-Address" << FormatLine.assign(47, '-');
		cout << endl << "\t" << HouseNum << ", " << StreetName << endl;
		cout << "\t" << City << endl;
...
public:
	...
	{
		Graphics(1);
		cout << "Customer: " << CustID << endl << CustName << endl << CustPhone;
